<template>
  <div>
    <div style="margin-bottom: 5px;">
      ...
      <el-button type="primary" style="margin-left: 5px;" @click="inGoods" v-if="user.role!=1">入库</el-button>
      <el-button type="primary" style="margin-left: 5px;" @click="outGoods" v-if="user.role!=1">出库</el-button>
    </div>
...
export default {
  ...
  methods:{
    ...
    loadPost(){
      this.$axios.post(this.$httpUrl+'/goods/page',{
